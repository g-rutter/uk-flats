...
def build():
    ...
    for location in data['locations']:
        ...
        row['safety_status'] = 'Separate recorded-offence rates available; no safety score'
        rows.append(row)
    ...
    print(f'Built broad screen for {len(rows)} locations; separate offence rates shown and combined rankings excluded.')
