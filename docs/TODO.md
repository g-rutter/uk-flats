...
- Re-acquire and document buying prices, rents, national-transport observations and market-stock snapshots for all 90 locations. The seven newest locations have no observations in these feeds; the existing price, rent and national-transport inputs are imported baseline observations, and 63 market observations also lack retained row-level captures. Promote a replacement only after its raw release, geography mapping, evidence and validation are complete.
