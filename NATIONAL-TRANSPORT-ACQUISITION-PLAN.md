...
- The full-route supplement is complete: the remaining 142 routes have four retained searches each, 1,278 retained request/response/metadata artifacts and a hash-verified manifest in `2026-09-08-national-transport-direct-supplement`. Its validated review-stage observations are in `data/inputs/transport_route_observations_direct_supplement.csv`. Together with the accepted pilot, `data/derived/national-transport-direct-full-review.csv` covers all 83 locations for review.
- The reviewed full table has been accepted for canonical replacement. The direct pilot and supplement observations remain retained route-level evidence; canonical values continue to be a dated station-to-station comparison, not door-to-door or guaranteed journeys.
